...
/******************************register base******************************************/
#define X100_PIPE_BASE(pipe)				(0x8000*pipe)
#define X100_DC_BASE(pipe)				(X100_PIPE_BASE(pipe) + 0x0000)
#define X100_DCREQ_BASE(pipe)				(X100_PIPE_BASE(pipe) + 0x2000)
#define X100_DP_BASE(pipe)				(X100_PIPE_BASE(pipe) + 0x3000)
#define X100_ADDRESS_TRANSFORM_BASE			0x4000
#define X100_PHY_ACCESS_BASE(pipe)			(X100_PIPE_BASE(pipe) + 0x5000)

#define E2000_DC_BASE(pipe)				(0x1000*pipe)
#define E2000_DP_BASE(pipe)				(0x4000 + 0x1000*pipe)
#define E2000_ADDRESS_TRANSFORM_BASE			0x8000
#define E2000_PHY_ACCESS_BASE(pipe)			(0x6000 + 0x1000*pipe)
/******************************register base end******************************************/
