...
#if IS_ENABLED(CONFIG_USB_PHYTIUM_GADGET)
struct phytium_ep {
...
#else
static inline int phytium_host_init(struct phytium_cusb *config)
{
	return 0;
}

static inline int phytium_host_uninit(struct phytium_cusb *config)
{
	return 0;
}
#endif
...
#else
static inline int phytium_gadget_init(struct phytium_cusb *config)
{
	return 0;
}

static inline int phytium_gadget_uninit(struct phytium_cusb *config)
{
	return 0;
}
#endif
